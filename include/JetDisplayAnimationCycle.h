...
#ifndef JetDisplayAnimationCycle_H
#define JetDisplayAnimationCycle_H
...
class JetDisplayAnimationCycle : public AnalysisCycle {

public:
  /// Default constructor
  JetDisplayAnimationCycle();
  /// Default destructor
  ~JetDisplayAnimationCycle();
...
private:
  ...
  ClassDef( JetDisplayAnimationCycle, 0 );
  bool Jet_contains_hard_particles(fastjet::PseudoJet jet,double ptcut);
}; // class JetDisplayAnimationCycle

#endif // JetDisplayAnimationCycle_H
